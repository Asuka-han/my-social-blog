	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Asuka-han/fund_analysis_akshare",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1446753441?spm_id_from=333.1007.0.0",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "Asyuki",
	bio: "当一个故事要结束的时候，我们总会像其他的开始，就像是，一切回到了从前。",
	typewriter: {
	...
	links: [
		...
		// 	name: "Gitee",
		// 	icon: "mdi:git",
		// 	url: "https://gitee.com/Asuka-han",
		// },
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/Asuka-han",
		},
		// {
		// 	name: "Codeberg",
		...
		// },
		{
			...
			url: "https://discord.com/users/1473260473888673885",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	title: "", // 公告标题，填空使用i18n字符串Key.announcement
		content: "欢迎访问我的个人博客～<br/>比较懒，应该不常更", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: [
		"/pio/models/ykn07/model.json",
		"/pio/models/ykn03/model.json",
		"/pio/models/ykn08/model.json",
		"/pio/models/ykn01/model.json",
		"/pio/models/ykn09/model.json",
		"/pio/models/ykn02/model.json",
		"/pio/models/ykn04/model.json",
		"/pio/models/ykn05/model.json",
		"/pio/models/ykn10/model.json",
		"/pio/models/ykn06/model.json",
		"/pio/models/ykn11/model.json",
		"/pio/models/seiz1/model.json",
		"/pio/models/seiz/model.json",
		"/pio/models/seiz4/model.json",
		"/pio/models/seiz2/model.json",
		"/pio/models/seiz3/model.json",		
		"/pio/models/mashiro04/Vo_event111.json",
		"/pio/models/live2d/Vo_event111.json",
		"/pio/models/mashiro01/Vo_event111.json",
		"/pio/models/mashiro03/Vo_event111.json",
		"/pio/models/mashiro02/Vo_event111.json",
		"/pio/models/lisa/model.json",
		"/pio/models/lisa1/model.json",
		"/pio/models/lisa2/model.json",
		"/pio/models/lisa3/model.json",
		"/pio/models/sayo2/model.json",
		"/pio/models/sayo1/model.json",
		"/pio/models/sayo/model.json",
	], // 默认模型路径
	position: "left", // 模型位置
	width: 300, // 默认宽度
	height: 520, // 默认高度
	...
	dialog: {
		welcome: "Welcome to Mizuki Website!", // 欢迎词s
		touch: [
			"再摸我就报警了！",
			"HENTAI!",
			"不可以这样欺负我啦！",
